...
document.getElementById("siBtn").addEventListener("click", function () {
  ...
  document.getElementById("messageContainer").innerHTML =
    "Genial ya se que haremos..??? jijiji";
...
document.getElementById("noBtn").addEventListener("click", function () {
  switch (noButtonState) {
    ...
    case 15:
      ...
      break;
    case 16:
      document.getElementById("noBtn").innerHTML = "¡Vamos, di que sí!";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 17:
      document.getElementById("noBtn").innerHTML = "Necesito que digas que sí";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 18:
      document.getElementById("noBtn").innerHTML = "¡Dale, hazme feliz!";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 19:
      document.getElementById("noBtn").innerHTML = "Te lo ruego, di que sí";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 20:
      ...
      document.getElementById("siBtn").style.padding = "220px 380px";

      noButtonState++;
      break;

    case 21:
      document.getElementById("noBtn").innerHTML = "Hazme el hombre más feliz";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";

      // Hacer que el botón "Sí" crezca
      document.getElementById("siBtn").style.fontSize = "400px";
      document.getElementById("siBtn").style.padding = "230px 400px";

      noButtonState++;
      break;

    case 22:
      document.getElementById("noBtn").innerHTML = "No me hagas esperar más";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";

      // Hacer que el botón "Sí" crezca
      document.getElementById("siBtn").style.fontSize = "420px";
      document.getElementById("siBtn").style.padding = "240px 420px";

      noButtonState++;
      break;

    case 23:
      document.getElementById("noBtn").innerHTML = "¡Dilo, por favor!";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";

      // Hacer que el botón "Sí" crezca
      document.getElementById("siBtn").style.fontSize = "440px";
      document.getElementById("siBtn").style.padding = "250px 440px";

      noButtonState++;
      break;

    case 24:
      document.getElementById("noBtn").innerHTML = "¡Hazme feliz!";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";

      // Hacer que el botón "Sí" crezca
      document.getElementById("siBtn").style.fontSize = "460px";
      document.getElementById("siBtn").style.padding = "260px 460px";

      noButtonState++;
      break;

    case 25:
      document.getElementById("noBtn").innerHTML = "No puedo esperar más";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";

      // Hacer que el botón "Sí" crezca
      document.getElementById("siBtn").style.fontSize = "480px";
      document.getElementById("siBtn").style.padding = "270px 480px";

      noButtonState++;
      break;

    case 26:
      document.getElementById("noBtn").innerHTML = "¡Hazlo ya!";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";

      // Hacer que el botón "Sí" crezca
      document.getElementById("siBtn").style.fontSize = "500px";
      document.getElementById("siBtn").style.padding = "280px 500px";
